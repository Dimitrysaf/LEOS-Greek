...
public class CatalogManipulationTests {
    ...
    public void testCreateCatalogWithCategoriesOnly_CompleteValidation() throws Exception {
        String result = documentService.createCatalogWithCategoriesOnly();
    ...
    public void testInsertTemplateIntoCatalog_CompleteValidation() throws Exception {
        ...
        String result = documentService.insertTemplateIntoCatalog(originalCatalog, "SJ-023", "Test Template", "123");
    ...
    public void testCombinedOperations_FullValidation() throws Exception {
        String categoriesOnly = documentService.createCatalogWithCategoriesOnly();
        ...
        String withTemplate = documentService.insertTemplateIntoCatalog(categoriesOnly, "SJ-023", "Test Template", "123");
    ...
    public void testInsertTemplateIntoCatalog_CustomAttributes() throws Exception {
        String result = documentService.insertTemplateIntoCatalog(
    ...
    public void testInsertTemplateIntoCatalog_NonExistentTemplate() throws Exception {
        documentService.insertTemplateIntoCatalog(CatalogTestData.BASE_CATALOG_XML, "NONEXISTENT_TEMPLATE", "Test", "123");
    }

    @Test
    public void testInsertTemplateIntoCatalog_MalformedXml() throws Exception {
        try {
            documentService.insertTemplateIntoCatalog(CatalogTestData.MALFORMED_XML, "SJ-023", "Test", "123");
    ...
    public void testInsertTemplateIntoCatalog_NullInputs() throws Exception {
        documentService.insertTemplateIntoCatalog(null, "SJ-023", "Test", "123");
    }

    @Test(expected = Exception.class)
    public void testInsertTemplateIntoCatalog_NullTemplateKey() throws Exception {
        documentService.insertTemplateIntoCatalog(CatalogTestData.BASE_CATALOG_XML, null, "Test", "123");
    }

    @Test(expected = Exception.class)
    public void testInsertTemplateIntoCatalog_EmptyTemplateKey() throws Exception {
        documentService.insertTemplateIntoCatalog(CatalogTestData.BASE_CATALOG_XML, "", "Test", "123");
    }
    ...
    public void testInsertTemplateIntoCatalogByCategory_ValidCategory() throws Exception {
        String result = documentService.insertTemplateIntoCatalogByCategory(
            CatalogTestData.BASE_CATALOG_XML, 
            "SJ-023",
            "LAW_INITIATIVE",
            "Test Template",
    ...
    public void testInsertTemplateIntoCatalogByCategory_InvalidCategory() throws Exception {
        documentService.insertTemplateIntoCatalogByCategory(
            CatalogTestData.BASE_CATALOG_XML, 
            "SJ-023",
    ...
    public void testRemoveTemplateFromCatalog_ExistingTemplate() throws Exception {
        String catalogWithTemplate = documentService.insertTemplateIntoCatalog(
        ...
        String result = documentService.removeTemplateFromCatalog(catalogWithTemplate, "SJ-023/123");
    ...
    public void testRemoveTemplateFromCatalog_NonExistentTemplate() throws Exception {
        ...
        String result = documentService.removeTemplateFromCatalog(originalCatalog, "NONEXISTENT/123");
    ...
    public void testRemoveTemplateFromCatalog_MultipleTemplates() throws Exception {
        ...
        catalog = documentService.insertTemplateIntoCatalog(catalog, "SJ-023", "Template 1", "123");
        catalog = documentService.insertTemplateIntoCatalog(catalog, "SJ-024", "Template 2", "456");
        
        Document beforeDoc = parseXml(catalog);
        CatalogStructure beforeStructure = analyzeCatalogStructure(beforeDoc);
        
        // Remove one template
        String result = documentService.removeTemplateFromCatalog(catalog, "SJ-023/123");
    ...
    public void testRemoveTemplateFromCatalog_LastTemplate() throws Exception {
        String categoriesOnly = documentService.createCatalogWithCategoriesOnly();
        String withTemplate = documentService.insertTemplateIntoCatalog(
        ...
        String result = documentService.removeTemplateFromCatalog(withTemplate, "SJ-023/123");
    ...
    public void testRemoveTemplateFromCatalog_PreserveCategoryStructure() throws Exception {
        String catalog = documentService.insertTemplateIntoCatalog(
            CatalogTestData.BASE_CATALOG_XML, "SJ-023", "Test Template", "123");
    ...
    public void testInsertAndRemoveTemplate_RoundTrip() throws Exception {
        ...
        // Remove template
        String backToOriginal = documentService.removeTemplateFromCatalog(withTemplate, "SJ-023/123");
    ...
    public void testRemoveTemplateFromCatalog_MalformedXml() throws Exception {
        documentService.removeTemplateFromCatalog(CatalogTestData.MALFORMED_XML, "SJ-023/123");
    }

    @Test(expected = Exception.class)
    public void testRemoveTemplateFromCatalog_NullCatalogXml() throws Exception {
        documentService.removeTemplateFromCatalog(null, "SJ-023/123");
    }

    @Test(expected = Exception.class)
    public void testRemoveTemplateFromCatalog_EmptyCatalogXml() throws Exception {
        documentService.removeTemplateFromCatalog("", "SJ-023/123");
    }

    @Test(expected = Exception.class)
    public void testRemoveTemplateFromCatalog_NullCustomKey() throws Exception {
        documentService.removeTemplateFromCatalog(CatalogTestData.BASE_CATALOG_XML, null);
    }

    @Test(expected = Exception.class)
    public void testRemoveTemplateFromCatalog_EmptyCustomKey() throws Exception {
        documentService.removeTemplateFromCatalog(CatalogTestData.BASE_CATALOG_XML, "");
    }
    ...
    public void testRemoveTemplateFromCatalog_DifferentPackageIds() throws Exception {
        ...
        catalog = documentService.insertTemplateIntoCatalog(catalog, "SJ-023", "Template 1", "123");
        catalog = documentService.insertTemplateIntoCatalog(catalog, "SJ-023", "Template 2", "456");
