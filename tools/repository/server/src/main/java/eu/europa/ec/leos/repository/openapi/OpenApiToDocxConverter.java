...
public class OpenApiToDocxConverter {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("OPEN API DOC Generating in leos service");
        if (args.length < 2) {
      ...
      //  String baselineDocxPath = "../../docs/REST/API/leos_service_api-documentation.docx";
        String baselineDocxPath = args[2] != null ? args[2] : "../../docs/REST/API/leos_repository_api-documentation.docx";
