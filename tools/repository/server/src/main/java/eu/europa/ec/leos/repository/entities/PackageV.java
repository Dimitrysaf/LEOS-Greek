...
@NamedQueries({
    ...
    @NamedQuery(name = "PackageV.findByDocTypeId", query = "SELECT p FROM PackageV p WHERE p.docTypeId = :docTypeId"),
    ...
    @NamedQuery(name = "PackageV.findByCollaborators", query = "SELECT p FROM PackageV p WHERE p.collaborators = :collaborators"),
    ...
    @NamedQuery(name = "PackageV.findByIsPrivateWorkingCopy", query = "SELECT p FROM PackageV p WHERE p.isPrivateWorkingCopy = :isPrivateWorkingCopy"),
    ...
    @NamedQuery(name = "PackageV.findByContent", query = "SELECT p FROM PackageV p WHERE p.content = :content"),
