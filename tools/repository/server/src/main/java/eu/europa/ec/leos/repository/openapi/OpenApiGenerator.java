package eu.europa.ec.leos.repository.openapi;
...
public class OpenApiGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OpenAPI openAPI = new OpenAPI()
                .info(new Info().title("LEOS REPOSITORY API").version(readVersion()).description("API documentation for LEOS Repository"))
                .paths(new Paths())
        ...
        for (Class<?> controller : findControllers(readProperty("app.controllers.package", "eu.europa.ec.leos.repository.controllers"))) {
    ...
    private static String readProperty(String key, String defaultValue) throws Exception {
        ...
        try (InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream("config/app-info.properties")) {
