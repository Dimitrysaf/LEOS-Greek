...
public interface PackageService {
    ...
    List<LeosDocument> findDocumentsByPackageIds(List<BigDecimal> packageIds, Set<String> categories);

    List<LeosDocument> findLegDocumentsByDocumentIds(List<String> documentIds);
