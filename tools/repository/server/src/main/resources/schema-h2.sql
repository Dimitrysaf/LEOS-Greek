...
(	ID NUMBER(22,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
     ...
     AUDIT_LAST_M_DATE TIMESTAMP (6),
     AUDIT_LAST_M_BY VARCHAR2(30 BYTE),
     IS_CUSTOM_TEMPLATE_ACT NUMBER(1,0)
);
...
SELECT doc.id||'_'||docver.id||'_'||doccat.id unique_id
     ...
     , docxml.act_type, docxml.doc_purpose, docxml.doc_type, docxml.eea_relevance, docxml.template, docxml.title, docver.comments, doc.is_archived, doc.is_custom_template_act, docver.is_version_archived, (SELECT
