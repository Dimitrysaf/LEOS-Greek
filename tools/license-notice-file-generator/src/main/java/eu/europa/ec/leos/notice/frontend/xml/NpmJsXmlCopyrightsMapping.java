...
import eu.europa.ec.leos.notice.backend.xml.MatchLevel;
import eu.europa.ec.leos.notice.common.NpmJsDependencyName;
...
public class NpmJsXmlCopyrightsMapping extends BaseXmlLoader {
    ...
    public NpmJsXmlCopyrightsMapping(Path copyrightsXml) throws ParserConfigurationException, IOException, SAXException {
        ...
        if(copyrightsLookup.isPresent()) {
            extractXmlArtifacts(copyrightsLookup.get()).forEach(this::populateMaps);
        } else {
