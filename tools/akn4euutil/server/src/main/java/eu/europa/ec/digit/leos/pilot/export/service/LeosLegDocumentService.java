...
public interface LeosLegDocumentService {
    LeosConvertDocumentOutput updateWithTranslations(LeosConvertDocumentInput convertDocumentInput, List<LeosRenditionOutput> renditionOutputs, String outputDescriptor);
}
