...
Thank You for Your interest in contributing to the LEOS 
(Legislation Editing Open Software) project currently developed by 
the European Union (hereafter the “Project Owner”, "We" or "Us"). 
We will ask You to give Us the right to use Your contribution 
(or in other words grant us a licence) for the purpose of developing 
and improving Our project.
...
she has read the terms of the Contributor Licence Agreement available [here](https://code.europa.eu/info/about/-/blob/master/dco-cla/ec-cla.pdf) 
