 ...
 */
; // jshint ignore:line
define(function aknInlineContentModule(require) {
    "use strict";
    ...
    var profileName = "Inline AKN Content";
    ...
    var profileConfig = {
        ...
        plugins: "toolbar,wysiwygarea,elementspath,clipboard,undo,button,dialog,dialogui,"
            + "widget,lineutils,basicstyles,"
            + "fakeobjects,specialchar,contextmenu,menubutton,colorbutton",
