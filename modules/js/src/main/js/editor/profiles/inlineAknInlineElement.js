 ...
 */
; // jshint ignore:line
define(function aknInlineElementProfileModule(require) {
    "use strict";
    ...
    plugins.push(require("plugins/aknInlineElement/aknInlineElementPlugin"));
    ...
    var profileName = "Inline AKN Inline element";
    ...
    var profileConfig = {
        ...
        plugins: "toolbar,wysiwygarea,elementspath,clipboard,undo,enterkey,button,"
            + "widget,lineutils,basicstyles,fakeobjects",
