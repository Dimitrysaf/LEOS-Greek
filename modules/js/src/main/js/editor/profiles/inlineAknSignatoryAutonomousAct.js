 ...
 */
; // jshint ignore:line
define(function aknSignatoryProfileModule(require) {
    "use strict";
    ...
    plugins.push(require("plugins/aknBlockSignatory/aknBlockSignatoryPlugin"));
    plugins.push(require("plugins/aknSignature/aknSignaturePlugin"));
    ...
    var profileConfig = {
        ...
        removeButtons: "Italic,Bold,Underline,Strike,TextColor,PasteFromWord",
