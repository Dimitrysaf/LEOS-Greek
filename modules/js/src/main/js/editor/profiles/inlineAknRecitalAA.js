 ...
 */
; // jshint ignore:line
define(function aknRecitalAAProfileModule(require) {
    "use strict";
    ...
    plugins.push(require("plugins/aknRecitalAA/aknRecitalAAPlugin"));
    ...
    var profileName = "AKN Recital Autonomous Act";
    ...
    var profileConfig = {
        ...
        toolbarGroups : [ {
            ...
            name : "insert", groups: [ "base64image" ]
        }, {
            name : "styles"
        }, {
            name : "tools"
