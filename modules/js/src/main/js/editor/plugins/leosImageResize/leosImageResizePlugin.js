 ...
 */
/**
 * Original version (v0.5.1): https://github.com/sstur/ck-dragresize
 */
; // jshint ignore:line
define(function leosImageResizePluginModule(require) {
    "use strict";
    
    var pluginTools = require("plugins/pluginTools");
    var pluginName = "leosImageResize";   
    ...
    function resizeElement(el, width, height) {
        ...
        //LEOS-Change added for compatibility with leos image plugin/comparison/etc.
