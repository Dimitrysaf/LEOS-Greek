...
define(function leosCrossReferenceDialog(require) {
                ...
                editor.LEOS.documentsMetadata.forEach(function (documentMetadata) {
                    if (documentMetadata.category !== "MEMORANDUM" && documentMetadata.category !== "COUNCIL_EXPLANATORY"
                        ...
                        dialogDefinitionCKE.addContents({
                            ...
                            label: getTabName(editor, documentMetadata.category, documentMetadata.index, documentMetadata.tlcReferenceNameFormatId),
                            elements: elements
                        });
                    }
                });
    ...
    function getTabName(editor, category, annexIndex, tlcReferenceNameFormatId) {
        switch (category) {
            case "MEMORANDUM":
