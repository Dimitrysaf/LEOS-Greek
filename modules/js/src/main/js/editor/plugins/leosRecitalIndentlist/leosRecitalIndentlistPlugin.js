 ...
 */
/**
 * @fileOverview Cloned from leosArticleIndentlistPlugin before Core#2475 to avoid finer granularity on indentation in recital lists
 */

; // jshint ignore:line
define(function leosRecitalIndentListPluginModule(require) {
    "use strict";
    ...
    var pluginName = "leosRecitalIndentlist";
