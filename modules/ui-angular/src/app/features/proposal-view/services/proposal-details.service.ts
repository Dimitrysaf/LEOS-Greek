...
export class ProposalDetailsService implements OnDestroy {
  ...
  updateProposalMetadata(docPurpose: string, eeaRelevance: boolean, packageTitle?: string, isAuthenticLang?: AuthenticLanguage,
                         ...
                         proposalType?: string, targetProposalReference?: string, targetProposalInterInstitutionalRefYear?: number,
  targetProposalInterInstitutionalRefNumber?: string, targetProposalInterInstitutionalRefType?: string, targetProposalDate?: Date, proposalTargetLang?: string[],
    ...
    return this.http
      .put<any>(`${apiBaseUrl}/secured/proposal/${this.proposalRef}`, {
        ...
        targetProposalInterInstitutionalRefYear,
        targetProposalInterInstitutionalRefNumber,
        targetProposalInterInstitutionalRefType,
        targetProposalDate,
        proposalTargetLang,
