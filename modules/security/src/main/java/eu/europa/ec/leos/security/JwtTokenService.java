...
class JwtTokenService implements TokenService {
    ...
    @Value("${leos.api.jwt.auth.client.dgt.id}")
    private String dgtClientId;
    @Value("${leos.api.jwt.auth.client.dgt.secret}")
    private String dgtSecret;
    ...
    private static final int DGT_TOKEN_EXPIRE_IN_MIN = 60;
    ...
    @Override
    public String getDgtToken(String user) {
        return createAccessToken(user, dgtClientId, DGT_TOKEN_EXPIRE_IN_MIN, dgtSecret, null);
    }
     ...
     */
    @Override
    public String getAccessToken(String user, AuthClient authClient) {
        return createAccessToken(user, leosApiId, accessTokenExpirationInMin, leosApiSecret, authClient);
    }

    @Override
    public String getNgAccessToken(String user) {
        return createAccessToken(user, ngClientId, NG_TOKEN_EXPIRE_IN_MIN, ngClientSecret,null);
    }
