...
public class FormatUtils {
    ...
    private static final String[] HTML_FORMATTING_ELEMENTS = { "sup", "sub", "b", "strong", "i", "em", "mark", "small" };
    private static final String HTML_TAGS = String.join("|", HTML_FORMATTING_ELEMENTS);
