...
class CmisMetadataExtensions {
    ...
    private static class CommonMetadataProperties {
        ...
        Boolean eeaRelevance, isCustomTemplateAct;
    }
    ...
    private static boolean getMetadataIsCustomTemplateAct(Document document) {
        Boolean isCustomTemplateAct = document.getPropertyValue(repositoryPropertiesMapper.getId(RepositoryProperties.METADATA_IS_CUSTOM_TEMPLATE_ACT));
