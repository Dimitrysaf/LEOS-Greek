class actViewerPage {
    elements = {
        ...
        euiDropDownItemContainer: () => cy.get('button .eui-dropdown-item__container'),
        euiDropDownItemContentText: () => this.elements.euiDropDownItemContainer().find('.eui-dropdown-item__content-text'),
        downloadBtn:() => this.elements.euiDropDownItemContentText().contains('Download'),
        ...
        reOrderBtn:()=> cy.xpath("//div/*[text()='Annexes']//ancestor::div[contains(@class,'eui-u-flex')]//button/span[text()=' Reorder ']"),
        addFinancialStatementBtn: () => cy.xpath("//div/*[text()='Legislative Financial and Digital Statement']//ancestor::div[contains(@class,'eui-u-flex')]//button//span[text()=' Add ']"),
        deleteFinancialStatementBtn: () => cy.xpath("//*[text()='Legislative Financial and Digital Statement']//ancestor::div[contains(@class,'eui-u-flex')]//button//span[text()=' Delete ']"),
    ...
    clickReorderButton(){
        this.elements.reOrderBtn().click();
    }
