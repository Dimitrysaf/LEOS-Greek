class importOfficeJournalWindow {
    elements = {
        ...
        selectAllRecitalsBtn: () => cy.get("button [translate='dialog.import-from-journal.footer.selectAllRecitals-button']"),
        selectAllArticlesBtn: () => cy.get("button [translate='dialog.import-from-journal.footer.selectAllArticles-button']"),
