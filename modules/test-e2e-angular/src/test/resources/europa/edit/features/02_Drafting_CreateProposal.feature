...
Feature: Create Proposal Regression Features in Edit Commission
  ...
  Scenario Outline: LEOS-4897,4517 [EC] Verify user is able to create the proposal successfully
    ...
    When click on template "<templateProposal>" under tree item "Interinstitutional procedures - Law Initiative (COM/JOIN)"
    ...
    And  no title is present in Annex 1
    ...
    When find the recent "zip" file from download path and unzip it in path "upload" and get the latest "leg" file
