...
@CucumberOptions(
        features = {"classpath:europa/edit/features/01_Revision_RepositoryBrowserPage.feature", "classpath:europa/edit/features/02_Revision_ProposalViewerPage.feature"}
...
public class RevisionTestRunner extends AbstractTestNGCucumberTests {
}