...
public final class MemorandumMetadata extends LeosMetadata {
    ...
    public MemorandumMetadata(String stage, String type, String purpose, String template, String language, String docTemplate, String ref, String packageRef,
        ...
        super(LeosCategory.MEMORANDUM, stage, type, purpose, template, language, docTemplate, ref, packageRef, objectId, docVersion, eeaRelevance,
                customTemplateAct, fromCustomTemplate, translated);
    }
    ...
    public static final class MemorandumMetadataBuilder {
        ...
        public MemorandumMetadataBuilder withFromCustomTemplate(boolean fromCustomTemplate) {
