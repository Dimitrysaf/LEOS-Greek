...
@JavaScript({"vaadin://../js/ui/extension/mathJaxConnector.js"+ LeosCacheToken.TOKEN })
public class MathJaxExtension<T extends AbstractField<V>, V> extends LeosJavaScriptExtension {

    private static final long serialVersionUID = 1L;

    public MathJaxExtension(T target) {
        super();
        extend(target);
    }
