...
@JavaScript({"vaadin://../js/ui/extension/refToLinkConnector.js" + LeosCacheToken.TOKEN})
public class RefToLinkExtension<T extends AbstractField<V>, V> extends LeosJavaScriptExtension {

    private static final long serialVersionUID = 1L;

    public RefToLinkExtension(T target) {
        super();
        extend(target);
    }
