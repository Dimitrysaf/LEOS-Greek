...
class AnnexPresenter extends AbstractLeosPresenter {
    ...
    private void populateVersionsData(Annex annex) {
        ...
        final List<ContributionVO> allContributions = contributionService.getDocumentContributions(documentRef, Annex.class);
    ...
    void fetchTocAndAncestors(FetchCrossRefTocRequestEvent event) {
        ...
        eventBus.post(new FetchCrossRefTocResponseEvent(new TocAndAncestorsVO(tocItemList, structureContextProvider.get().getTocItems(), elementAncestorsIds,
                messageHelper,
