...
class LegServiceImplTest {
    ...
    void setUp() {
        ...
        languageMap.put("latin",
                Arrays.asList("cs", "da", "de", "en", "es", "et", "fi", "fr", "ga", "hr", "hu", "it", "lt", "lv", "mt", "nl", "pl", "pt", "ro", "sk", "sl",
                        "sv"));
    ...
    private Annex getMockedAnnex(List<Collaborator> collaborators) {
        ...
        return new Annex("555", "annex_cl3yjnpcz0007k485t5p989mq.xml", "login", Instant.now(), "login", Instant.now(),
                ...
                Option.some(content), Option.some(annexMetadata), false, false, null, null, null, null, null);
    }
