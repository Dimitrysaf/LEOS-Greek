...
public class BillServiceImplTest {
    ...
    @Test
    public void test_saveTableOfContent_should_call_correctNumberOfProcessors() throws Exception {
        // Given
        Content content = mock(Content.class);
        Content.Source source = mock(Content.Source.class);
        final byte[] byteContent = new byte[]{1, 2, 3};
        final BillMetadata billMetadata = new BillMetadata("", "REGULATION", "", "SJ-023", "EN", "BL-023", "bill-id", "", "0.1.0", false, false);
