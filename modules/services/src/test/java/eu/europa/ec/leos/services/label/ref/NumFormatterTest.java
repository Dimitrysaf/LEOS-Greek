...
public class NumFormatterTest extends LeosTest {
    ...
    public void isUnnumbered_unNum_paragraph() {
        //setup
        TreeNode testNode = new TreeNode(PARAGRAPH, 0, 1, "id", null, null, null, null, false);
    ...
    public void isUnnumbered_unNum_paragraph2() {
        //setup
        TreeNode testNode = new TreeNode(PARAGRAPH, 0, 1, "id", "", null, null, null, false);
        assertEquals(true, NumFormatter.isUnnumbered(testNode));
    }
    ...
    public void isUnnumbered_unNum_point() {
        //setup
        TreeNode testNode = new TreeNode(POINT, 0, 1, "id", "-", null, null, null, false);
        assertEquals(true, NumFormatter.isUnnumbered(testNode));
    }
    ...
    public void isUnnumbered_num_paragraph() {
        //setup
        TreeNode testNode = new TreeNode(PARAGRAPH, 0, 1, "id", "1", null, null, null, false);
    ...
    public void formatUnnumbered_eighth_en() {
        //setup
        TreeNode testNode = new TreeNode(PARAGRAPH, 0, 8, "id", "", null, null, null, false);
    ...
    public void formatUnnumbered_third() {
        //setup
        TreeNode testNode = new TreeNode(PARAGRAPH, 0, 3, "id", "", null, null, null, false);
        //Need to define spellout/ordinal rules for french. as of now using simple representation
