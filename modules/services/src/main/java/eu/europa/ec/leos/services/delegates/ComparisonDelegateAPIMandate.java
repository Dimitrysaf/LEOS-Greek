...
public class ComparisonDelegateAPIMandate<T extends XmlDocument> extends ComparisonDelegateAPI<T> {

    public ComparisonDelegateAPIMandate(TransformationService transformerService, ContentComparatorService compareService,
