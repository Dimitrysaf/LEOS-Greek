...
@Component
@Scope("prototype")
public abstract class ComparisonDelegateAPI<T extends XmlDocument> {

    private static final Logger LOG = LoggerFactory.getLogger(ComparisonDelegateAPI.class);
    ...
    @Autowired
    public ComparisonDelegateAPI(TransformationService transformerService, ContentComparatorService compareService,
