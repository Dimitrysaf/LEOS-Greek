...
public class XmlNodeConfigProcessorImpl implements XmlNodeConfigProcessor {
    ...
    private static Map<String, XmlNodeConfig> createProposalConfig() {
        ...
        coverPageConfig.put(DOC_STAGE_COVER, new XmlNodeConfig("//akn:coverPage/akn:longTitle/akn:p/akn:docStage", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "docStage"))));
        coverPageConfig.put(DOC_TYPE_COVER, new XmlNodeConfig("//akn:coverPage/akn:longTitle/akn:p/akn:docType", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "docType"))));
        coverPageConfig.put(DOC_PURPOSE_COVER, new XmlNodeConfig("//akn:coverPage/akn:longTitle/akn:p/akn:docPurpose", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "docPurpose"))));
        coverPageConfig.put(DOC_LANGUAGE_COVER, new XmlNodeConfig("//akn:coverPage/akn:container[@name='language']/akn:p", false, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "container"))));
        coverPageConfig.put(DOC_EEA_RELEVANCE_COVER, new XmlNodeConfig("//akn:coverPage/akn:container[@name='eeaRelevance']/akn:p", true,
                Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "container"),
                new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "p")),
    ...
    private static Map<String, XmlNodeConfig> createBillConfig() {
        ...
        prefaceConfig.put(DOC_STAGE_PREFACE, new XmlNodeConfig("//akn:preface/akn:longTitle/akn:p/akn:docStage", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "docStage"))));
        prefaceConfig.put(DOC_TYPE_PREFACE, new XmlNodeConfig("//akn:preface/akn:longTitle/akn:p/akn:docType", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "docType"))));
        prefaceConfig.put(DOC_PURPOSE_PREFACE, new XmlNodeConfig("//akn:preface/akn:longTitle/akn:p/akn:docPurpose", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "docPurpose"))));
        prefaceConfig.put(DOC_EEA_RELEVANCE_PREFACE, new XmlNodeConfig("//akn:preface/akn:container[@name='eeaRelevance']/akn:p",
                true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "container"),
                new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "p")),
    ...
    private static Map<String, XmlNodeConfig> createExplanatoryConfig() {
        ...
        final Map<String, XmlNodeConfig> prefaceConfig = new HashMap<>(4);
        prefaceConfig.put(EXPLANATORY_TITLE_PREFACE, new XmlNodeConfig("//akn:preface/akn:longTitle/akn:p/akn:docTitle", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "docTitle"))));
    ...
    private static Map<String, XmlNodeConfig> createAnnexConfig() {
        ...
        metadataConfig.put(ANNEX_INDEX_META, new XmlNodeConfig("/akn:akomaNtoso//akn:meta/akn:proprietary/leos:annexIndex", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "leos:annexIndex"), new XmlNodeConfig.Attribute("source", "~COM", "proprietary"))));
        metadataConfig.put(ANNEX_NUMBER_META, new XmlNodeConfig("/akn:akomaNtoso//akn:meta/akn:proprietary/leos:annexNumber", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "leos:annexNumber"), new XmlNodeConfig.Attribute("source", "~COM", "proprietary"))));
        metadataConfig.put(ANNEX_TITLE_META, new XmlNodeConfig("/akn:akomaNtoso//akn:meta/akn:proprietary/leos:annexTitle", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "leos:annexTitle"), new XmlNodeConfig.Attribute("source", "~COM", "proprietary"))));
        metadataConfig.put(ANNEX_CLONED_REF_META, new XmlNodeConfig("/akn:akomaNtoso//akn:meta/akn:proprietary/leos:clonedRef", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "leos:clonedRef"), new XmlNodeConfig.Attribute("source", "~COM", "proprietary"))));
        annexConfigMap.putAll(metadataConfig);

        final Map<String, XmlNodeConfig> prefaceConfig = new HashMap<>(2);
        prefaceConfig.put(ANNEX_NUMBER_PREFACE, new XmlNodeConfig("//akn:preface/akn:container/akn:block[@name='num']", false, Arrays.asList(new XmlNodeConfig.Attribute("name", "headerOfAnnex", "container"), new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "container"), new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "block"))));
        prefaceConfig.put(ANNEX_TITLE_PREFACE, new XmlNodeConfig("//akn:preface/akn:container/akn:block[@name='heading']", false, Arrays.asList(new XmlNodeConfig.Attribute("name", "headerOfAnnex", "container"), new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "container"), new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "block"))));
    ...
    public Map<String, XmlNodeConfig> getOldPrefaceOfAnnexConfig() {
        ...
        oldPrefaceConfig.put(ANNEX_NUMBER_PREFACE, new XmlNodeConfig("//akn:preface/akn:longTitle/akn:p/akn:docType", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "docType"))));
        oldPrefaceConfig.put(ANNEX_TITLE_PREFACE, new XmlNodeConfig("//akn:preface/akn:longTitle/akn:p/akn:docTitle", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "docTitle"))));
    ...
    private static Map<String, XmlNodeConfig> populateMetadataConfigMap() {
        ...
        metadataConfig.put(DOC_STAGE_META, new XmlNodeConfig("/akn:akomaNtoso//akn:meta/akn:proprietary/leos:docStage", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "leos:docStage"), new XmlNodeConfig.Attribute("source", "~COM", "proprietary"))));
        metadataConfig.put(DOC_TYPE_META, new XmlNodeConfig("/akn:akomaNtoso//akn:meta/akn:proprietary/leos:docType", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "leos:docType"), new XmlNodeConfig.Attribute("source", "~COM", "proprietary"))));
        metadataConfig.put(DOC_PURPOSE_META, new XmlNodeConfig("/akn:akomaNtoso//akn:meta/akn:proprietary/leos:docPurpose", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "leos:docPurpose"), new XmlNodeConfig.Attribute("source", "~COM", "proprietary"))));
        ...
        metadataConfig.put(DOC_TEMPLATE, new XmlNodeConfig("/akn:akomaNtoso//akn:meta/akn:proprietary/leos:template", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "leos:template"))));
        metadataConfig.put(DOC_SPECIFIC_TEMPLATE, new XmlNodeConfig("/akn:akomaNtoso//akn:meta/akn:proprietary/leos:docTemplate", true, Arrays.asList(new XmlNodeConfig.Attribute("xml:id", CUID.randomCUID1().toString(), "leos:docTemplate"))));
