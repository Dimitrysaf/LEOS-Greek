...
public interface XmlContentProcessor {
    ...
    byte[] cleanTrackChanges(byte[] xmlContent, String elementId);
    ...
    byte[] repeatGroup(byte[] xmlContent, String idAttributeValue, boolean before, boolean isTrackChangesEnabled);
    ...
    /**
     * removing an attribute {@param attributeName} on all children of an XML element {@param parentTag}.
     *
     * @param xmlContent
     * @param parentTag
     * @param attributeName
     * @return: On success returns updated content. On failure throws exception.
     */
    byte[] removeAttributeForAllChildren(byte[] xmlContent, String parentTag, List<String> elementTags, String attributeName);
    ...
    List<String> extractElementIdsFromBill(byte[] documentBytes);
}
